...
1.  [lisp基础知识](#org5c79121)
    1.  [lisp求值](#org10cd56e)
    2.  [elisp函数中的quote](#org7bef6e1)
    3.  [lisp谓词eq,eql,equal](#org073dbce)
2.  [lisp构想例](#org093e1f6)
    1.  [读取url让firefox打开](#org2eff7ec)
    2.  [去掉list重复项目](#org27d62df)
    3.  [删除list中的一项](#org8d9eaed)
    4.  [求全组合](#org3d9df39)
