...
1.  [c++11语法甜点](#org6b2f9c1)
2.  [C++14的return type deduction](#orge5b5c62)
3.  [c++真有点吓人](#org3c300bd)
4.  [When weakptr useful](#org753170a)
5.  [明白了就看看这个 is<sub>base</sub><sub>of</sub>](#org1d29763)
...
# 明白了就看看这个 is<sub>base</sub><sub>of</sub>
...
has<sub>member</sub>< A >::value 首先找到的是主定义has<sub>member</sub>< A, void >
...
所以这个特化必须匹配has<sub>member</sub>< A, void >， 所以要用void<sub>t</sub>
